...
while int(movieDate)//10000 == 2019:
    url = f"http://www.kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key=8a2185fe5f7983bb426b45950790cbe7&targetDt={movieDate}"
...
dataframe.to_csv("webmovie/cine.csv")
